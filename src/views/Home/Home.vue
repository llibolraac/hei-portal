<template>
  <div class="bg-white min-h-screen">
    ...
    <section class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
      ...
      <p
        class="mb-8 text-lg font-normal text-gray-600 lg:text-xl sm:px-16 lg:px-48"
      >
        We're so excited to have you on board! Thank you for being one of the
        first to check out our system while it's still fresh and new. We're busy
        adding cool features and making everything sparkle. If you dream up any
        brilliant ideas for data you'd like to see, please send them our way.
    ...
    <div
      class="max-w-screen-xl mx-auto px-4 pb-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6"
    >
      <div
        class="bg-white border border-gray-200 rounded-lg shadow p-6 text-center"
      >
    ...
    <div
      class="max-w-screen-xl mx-auto px-4 pb-16 grid grid-cols-1 md:grid-cols-2 gap-6"
    >
      <!-- Upcoming Activities -->
