...
<template>
  <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-4">
    ...
    <ul
      class="mt-4 flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400"
    ...
    >
      <li class="me-2">
        <button
          ...
          aria-selected="true"
          :class="{
            'inline-block px-4 py-3 text-white bg-blue-600 rounded-lg hover:text-white':
      ...
      <li class="me-2">
        <button
          ...
          :class="{
            'inline-block px-4 py-3 text-white bg-blue-600 rounded-lg hover:text-white':
              currentTab === 'Generate Billing Documents',
            'inline-block px-4 py-3 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white':
              currentTab !== 'Generate Billing Documents',
          }"
      ...
      <li>
        <button
          ...
          :class="{
            'inline-block px-4 py-3 text-white bg-blue-600 rounded-lg hover:text-white':
              currentTab === 'Generate SUC Voucher',
            'inline-block px-4 py-3 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white':
              currentTab !== 'Generate SUC Voucher',
          }"
          @click="switchToGenerateSUCVoucher"
        >
      ...
      <li class="me-2">
        <button
          ...
          type="button"
          role="tab"
          aria-controls="consolidated-suc"
          aria-selected="false"
          :class="{
            'inline-block px-4 py-3 text-white bg-blue-600 rounded-lg hover:text-white':
              currentTab === 'Cons. SUC Vouchers',
            'inline-block px-4 py-3 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white':
              currentTab !== 'Cons. SUC Vouchers',
          }"
          @click="switchToConsolidatedSUC"
        >
          Cons. SUC Vouchers
        </button>
      </li>
    ...
    <div id="tabContent">
      ...
      >
        <BillingDocuments
          v-if="currentTab === 'Billing Documents'"
      ...
      <div
        id="generate-billing-documents"
        role="tabpanel"
        class="p-2 bg-white rounded-lg dark:bg-gray-800"
      >
        <GenerateBilling
          v-if="currentTab === 'Generate Billing Documents'"
          :schoolYearId="schoolYearId"
          :semesterId="semesterId"
        />
      </div>
      ...
      <div
        id="generate-suc-voucher"
        role="tabpanel"
        class="p-2 bg-white rounded-lg dark:bg-gray-800"
      >
        <GenerateSUCVoucher
          v-if="currentTab === 'Generate SUC Voucher'"
          :schoolYearId="schoolYearId"
          :semesterId="semesterId"
        />
      </div>
      ...
      <div
        ...
        class="p-2 bg-white rounded-lg dark:bg-gray-800"
      >
        <ConsolidatedSUCVouchers
          v-if="currentTab === 'Cons. SUC Vouchers'"
          :schoolYearId="schoolYearId"
          :semesterId="semesterId"
        />
      </div>
      ...
      <div
        id="unbilled-grantees"
        role="tabpanel"
        class="p-2 bg-white rounded-lg dark:bg-gray-800"
      >
        <UnbilledGrantees
          v-if="currentTab === 'Unbilled Grantees'"
          :schoolYearId="schoolYearId"
          :semesterId="semesterId"
        />
      </div>
...
import GenerateSUCVoucher from "./Components/GenerateSUCVoucher.vue";
...
export default {
  ...
  methods: {
    ...
    switchToGenerateSUCVoucher() {
      this.currentTab = "Generate SUC Voucher";
    },
    switchToConsolidatedSUC() {
      this.currentTab = "Cons. SUC Vouchers";
    },
  },
