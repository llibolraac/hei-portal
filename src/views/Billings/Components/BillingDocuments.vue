    ...
    <div class="mt-2">
      <div v-show="currentTab === 'billing_details'" class="p-4 bg-white">
        ...
        <form class="max-w mx-auto">
            ...
            <div class="mb-5">
            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Billing Document Status:</label>
            <span v-if="formData.billing_status.id === 1" class="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-red-900 dark:text-red-300">{{ formData.billing_status.status_name }}</span>
            </div>
