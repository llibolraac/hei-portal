    ...
    <div class="overflow-x-auto">
      <table class="min-w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          ...
          >
            <td class="px-4 py-3 max-w-[120px] truncate">{{ grantee.grantees.lastname }}</td>
            <td class="px-4 py-3 max-w-[120px] truncate">{{ grantee.grantees.firstname }}</td>
            <td class="px-4 py-3 max-w-[120px] truncate">{{ grantee.grantees.middlename }}</td>
          </tr>
        </tbody>
      </table>
